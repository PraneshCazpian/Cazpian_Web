          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
                {(content.hero_title || resourcesContent.heroTitle).split('&').map((part, index) => (
                  <React.Fragment key={index}>
                    {part.trim()}
                    {index < (content.hero_title || resourcesContent.heroTitle).split('&').length - 1 && (
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl lg:max-w-none mb-8">
                {content.hero_subtitle || resourcesContent.heroSubtitle}
              </p>
